...
public class LeaveRequestService {
    ...
    public LeaveRequest createLeaveRequest(LeaveRequest leaveRequest) {
        ...
        for (User admin : admins) {
            notificationService.createNotification(admin, "New leave request from " + leaveRequest.getUser().getName());
        }
    ...
    public LeaveRequest rejectLeaveRequest(Long id) {
        ...
        if (requestOpt.isPresent()) {
            ...
            // Notify user
            notificationService.createNotification(request.getUser(),"Your leave request has been rejected");
